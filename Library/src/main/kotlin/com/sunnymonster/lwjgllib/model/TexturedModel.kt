...
import com.sunnymonster.lwjgllib.gl.Texture
 ...
 */
class TexturedModel(texturePath : String, isRgba : Boolean, model : RawModel, texCoords : FloatArray) : AutoCloseable {
    private val texture : Texture
    private val model : RawModel

    init {
        texture = Texture(texturePath, isRgba)
        this.model = model
